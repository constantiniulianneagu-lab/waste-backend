// ============================================================================
// DISPOSAL REPORTS CONTROLLER - UPDATED WITH ACCESS CONTROL
// ============================================================================
...
export const getDisposalTickets = async (req, res) => {
  ...
  try {
    ...
    console.log('📅 Fetching available years for Disposal...');
    ...
    console.log('✅ Disposal tickets fetched successfully');
