...
export const getStats = async (req, res) => {
  ...
  try {
    ...
    // ----------------------------------------------------------------------
    // 8B) MONTHLY EVOLUTION BY SECTORS (stacked series for chart)
    // ----------------------------------------------------------------------
    ...
    // Build sector keys (sector_1, sector_2, etc.)
    ...
    for (const r of monthlyByCodeRes.rows) {
      ...
      // Bucket into top codes or ALTELE
    ...
    const response = {
      ...
      data: {
        ...
        monthly_evolution_sectors: monthly_evolution_sectors,
        monthly_sector_keys: monthly_sector_keys,
        monthly_evolution_codes: monthly_evolution_codes,
        monthly_code_keys: monthly_code_keys,
